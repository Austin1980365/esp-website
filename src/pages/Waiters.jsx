    ...
    <div className="bg-white text-gray-900 font-sans">
      ...
      <section className="px-6 py-20 text-center max-w-5xl mx-auto">
        ...
        <p className="text-gray-700 mb-10">
          Established in 2007, ESP has been supplying waiters to demanding hospitality
      ...
      <section className="px-6 py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg mb-6">
            ESP supplies professional event waiters across Johannesburg, Pretoria,
            Midrand, Centurion, and the greater Gauteng region. Our teams are experienced
            in conferences, exhibitions, banquets, and corporate hospitality.
          </p>
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="list-disc list-inside space-y-3 text-lg">
            <li>Hospitality-trained professional waiters</li>
      ...
      <section className="px-6 py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg">
            ESP has supplied professional waiters to
            <strong> Gallagher Convention Centre since 2007</strong>, one of South
            Africa’s busiest conference and exhibition venues. This long-standing
            relationship reflects our ability to deliver consistent, high-quality
            service in demanding hospitality environments.
          </p>
        </div>
      </section>
